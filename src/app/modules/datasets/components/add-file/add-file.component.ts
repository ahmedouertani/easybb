...
export class AddFileComponent implements OnInit {
  ...
  constructor( private dialogRef: MatDialogRef<DialogAddUserComponent>, private activatedRoute: ActivatedRoute , private fb: FormBuilder, private ds: datasetService, private dialog: MatDialog ,  private _snackBar: MatSnackBar , @Inject(MAT_DIALOG_DATA) private data: any) {
  ...
  onSubmit(): void {
    ...
    uploadedFile.append('table_name', data.table_name);
    ...
    this.ds.powst(this.domaineId , this.data.folderId ,uploadedFile).subscribe((res: any) => {
